...
my_labeller <- as_labeller(c("entire data"="No~filter",
                             "wind_speed>10" ="u>10~m~s^-1",
                             "specific_humidity>2"="q>2~g~kg^-1",
                             "specific_humidity<1"="q<1~g~kg^-1",
                             "Ts_higher"="T[s]>-10~degree*C", 
                             "Ts_lower"="T[s]<{-10}~degree*C"), default = label_parsed)
...
# Save
ggsave("./DJFMA_new_files/djfma_subli_different_filters_revised.jpeg", units="in", width=5.5, height=7.2, dpi=300)
